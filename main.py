...
def mostrar_menu():
    print('\n --- Menu de gestion de Pet Shop ---')  
    print('1. Registrar Mascota')
    print('2. Registrar Cliente')
    print('3. Registrar Producto')
    print('4. Registrar Venta')
    print('5. Mostras informacion acerca de  Mascotas')
    print('6. Mostras informacion acerca de  Clientes')
    ...
    while True:
        ...
        if opcion == '1':
            ...
            if mascota:
                ...
                print('Mascota registrada con extio')
        elif opcion =='2':
            ...
            print('Saliendo del sistema. Gracias por usar Pet Shop App!')
            break
        else:
